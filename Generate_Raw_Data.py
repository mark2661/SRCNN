...
DATA_PATH = os.path.join(os.curdir, 'TrainingData', 'T91')
...
def write_hdf5(data, labels, output_filename):
    ...
    """
    output_file_path = os.path.join(os.curdir, 'TrainingData', output_filename)
    x = data.astype(numpy.float32)
    y = labels.astype(numpy.float32)

    with h5py.File(output_file_path, 'w') as h:
